...
<div id="chat">
    ...
    <div class="input-content">
        <el-input v-model="message" placeholder="请输入信息" :type="inputType"></el-input>
        <el-button type="primary" color="#18c5a3" @click="sendMsg"><span style="color:white">发送</span></el-button>
    </div>
</div>
</template>
